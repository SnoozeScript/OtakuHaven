...
const TVShowDetail = () => {
  ...
  <div className="lg:col-span-2">
    ...
    <div className="mt-4">
      {/* Row with Prev, Season, Episode, and Next buttons */}
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="px-4 py-2 bg-gray-700 rounded text-white text-center">
      ...
      {/* VidSrc and Multi buttons stacked vertically */}
